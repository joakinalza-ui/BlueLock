...
const PLAYER_DETAIL_PLACEHOLDER = "assets/characters/portraits/placeholder.png";
    ...
    return `
        <div class="mission-row${claimed ? " is-claimed" : ""}">
            ...
            <div class="mission-reward">
                <span class="mission-reward-amount"><span class="diamond-icon"><img src="${resolveAssetPath("assets/ui/diamond-icon.png")}" alt=""></span>${mission.reward}</span>
                ${actionHtml}
            </div>
        </div>
    `;
